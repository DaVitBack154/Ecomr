...
.card-list {
    ...
    background-image: url('asset/image/1(1).jpg');
    background-size: contain;
    background-repeat: no-repeat;
            ...
            <div class="row">
                <div class="grid">
                    <div class="card mb-4">
                        ...
                        <div class="card-detail text-center  w-100">
                            <div class="d-flex flex-column justify-content-center w-100">
                                <h5 class="card-title">Pastrami bacon</h5>
                                <div class="rating-2">    
                                ...
                                <div class="content_price price-2 d-flex mx-auto mt-1">
                                  <span class="price-2-new product-price">$55.00 </span>&nbsp;&nbsp;
                                  <span class="price-2-old">$76.00 </span>&nbsp;
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
